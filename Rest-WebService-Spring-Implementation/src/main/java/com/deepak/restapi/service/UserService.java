...
public class UserService {
	public static User userInfo(Integer id) {
		return MessengerDB.getUserMap().get(id);
	}

	public static List<User> usersInfo() {
	...
	public static User updateUser(Integer userId, User user) {
	...
	public static List<User> deleteUser(Integer userId) {
